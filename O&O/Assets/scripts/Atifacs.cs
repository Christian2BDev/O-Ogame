...
public class Atifacs : MonoBehaviour
{
...

    {
        ...
        if (PlayerPrefs.GetInt("fly") == 1) { /*change duble jump boolean*/ djump.text = "ja"; Movement.jumpmodi = 99999999; } 
        else if (PlayerPrefs.GetInt("CapeEnabled") == 1) { /*change duble jump boolean*/ djump.text = "ja"; Movement.jumpmodi = 2; }else { djump.text = "nee"; Movement.jumpmodi = 1; }
